Summary:    Extract values from line delimited JSON.
Name:       ldjtab
Version:    0.1.3
Release:    0
License:    MIT
...
URL:        https://github.com/miku/ldjtab

%description

Extract values from line delimited JSON.
...
install -m 755 ldjtab $RPM_BUILD_ROOT/usr/local/sbin
install -m 755 uldjtab $RPM_BUILD_ROOT/usr/local/sbin
...
%files
%defattr(-,root,root)
/usr/local/sbin/ldjtab
/usr/local/sbin/uldjtab
